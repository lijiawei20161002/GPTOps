...
class SummaryAgent:
    def __init__(self, openai_api_key, openai_organization):
        ...
        or probabilistic data that supports the prediction, and a conclusion summarizing the potential impact of these trends on the overall infrastructure status.\
        Output the confidence of your prediction ranging from 0 to 1, with a label < conf idence >."
